-- Clean and standardize NYC Open Restaurant application request data
...
cleaned AS (
   ...
   AND CAST(CAST(time_of_submission AS TIMESTAMP) AS DATE) >= DATE_SUB(CURRENT_DATE(), INTERVAL 7 YEAR)
